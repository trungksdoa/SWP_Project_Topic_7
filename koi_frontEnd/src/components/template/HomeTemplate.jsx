    ...
    <div>
      <AnimatedSection className="grid grid-cols-3">
        <div className="col-span-1 flex flex-col justify-center items-center ml-[100px]">
          <h1 className="text-[52px] font-bold">
            KoiControl - The Koi Web For Your Pond
          </h1>
      ...
      <AnimatedSection className="grid grid-cols-3">
        ...
        <div className="col-span-2 flex flex-col justify-center items-center ml-[100px]">
          ...
          <p className="text-[24px] text-gray-500">
            How much food do your koi need to grow ideally? Our integrated food
            calculator provides you with the answer. Based on your koi
            population and the water temperature, our food calculator
            automatically calculates the recommended amount of food for your
            koi. KoiControl can determine the weight very accurately based on
      ...
      <AnimatedSection className="grid grid-cols-3 mb-[100px]">
        <div className="col-span-1 flex flex-col justify-center items-center ml-[100px]">
          ...
          <p className="text-[24px] text-gray-500">
            Salt is a popular tool for treating koi diseases, as it is both
            cheap and effective against some parasites or algae. However,
            meticulous care must be taken to achieve the correct concentration.
            With the salt calculator you can calculate the correct dosage for
            each of your managed ponds without errors and without calculators.
          </p>
        </div>
        <div className="col-span-2 flex justify-center items-center">
          <img
