  ...
  return (
    <div className="w-full bg-black-400">
      <footer className="px-4 divide-y bg-black text-white">
        ...
        <div className="container pb-10 justify-between  lg:pb-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 !z-10 content">
          <div className="grid grid-cols-5 text-sm gap-x-3 gap-y-8 col-span-2 text-center">
            <div className="col-span-1 mx-auto  my-[50px] flex justify-center">
              ...
              >
                ...
                <p className="text-orange-400 font-bold text-[40px]">
                  Koi Control
                </p>
              </NavLink>
            </div>
